...
describe('remote-content', () => {
	it('should replace remote content URLs in all style declarations', () => {
		const input = `
			<html>
				<head>
					<style>
    ...
    <html lang="en-GB" manifest="REPLACED_URL">
    	...
    	<body>
    		...
    		<style type="text/css"></style><object type="image/svg+xml" data="REPLACED_URL"><embed type="image/svg+xml" src="REPLACED_IMAGE"></object><iframe src="REPLACED_IMAGE" width="1" height="1"></iframe><span></span><img width="16" height="16" src="REPLACED_IMAGE"><img src="REPLACED_IMAGE" width="16" height="16"><input type="image" src="REPLACED_IMAGE"><a href="REPLACED_URL"></a><link rel="dns-prefetch" href="REPLACED_URL"><link rel="prefetch" href="REPLACED_URL"><video src="REPLACED_IMAGE" width="1" height="1"></video><video poster="REPLACED_IMAGE" width="1" height="1">
